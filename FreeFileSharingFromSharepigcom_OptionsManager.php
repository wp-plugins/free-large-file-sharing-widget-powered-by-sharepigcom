...
class FreeFileSharingFromSharepigcom_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'free-file-sharing-from-sharepigcom'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'free-file-sharing-from-sharepigcom'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'free-file-sharing-from-sharepigcom'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'free-file-sharing-from-sharepigcom'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'free-file-sharing-from-sharepigcom');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'free-file-sharing-from-sharepigcom'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'free-file-sharing-from-sharepigcom');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'free-file-sharing-from-sharepigcom'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'free-file-sharing-from-sharepigcom') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'free-file-sharing-from-sharepigcom');
            case 'false':
                return __('false', 'free-file-sharing-from-sharepigcom');

            case 'Administrator':
                return __('Administrator', 'free-file-sharing-from-sharepigcom');
            case 'Editor':
                return __('Editor', 'free-file-sharing-from-sharepigcom');
            case 'Author':
                return __('Author', 'free-file-sharing-from-sharepigcom');
            case 'Contributor':
                return __('Contributor', 'free-file-sharing-from-sharepigcom');
            case 'Subscriber':
                return __('Subscriber', 'free-file-sharing-from-sharepigcom');
            case 'Anyone':
                return __('Anyone', 'free-file-sharing-from-sharepigcom');
        }
        return $optionValue;
    }
