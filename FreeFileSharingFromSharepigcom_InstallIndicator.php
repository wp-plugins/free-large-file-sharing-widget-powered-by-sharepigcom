...
include_once('FreeFileSharingFromSharepigcom_OptionsManager.php');

class FreeFileSharingFromSharepigcom_InstallIndicator extends FreeFileSharingFromSharepigcom_OptionsManager {
