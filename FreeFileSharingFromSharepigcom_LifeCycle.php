...
include_once('FreeFileSharingFromSharepigcom_InstallIndicator.php');

class FreeFileSharingFromSharepigcom_LifeCycle extends FreeFileSharingFromSharepigcom_InstallIndicator {
